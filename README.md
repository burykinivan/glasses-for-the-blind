...
Для запуска устройства подключите повербанк. Поверните устройство гладкой поверхности к себе, справа внизу вставьте провод от паввербанка, рядом с кнопкой. Поставте руку перед отчками. Если пищалка издаёт щелчки то прибор работает. Если нет, то нажмите на красную кнопку.
